...
export default function InventoryCard() {
	...
	return (
		<div className="mx-12 bg-gray-300 shadow rounded relative overflow-x-auto p-4 grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-8">
			<Cards
				imageUrl={
...
function Cards({ imageUrl, productName, onClick }) {
	return (
		<div
			onClick={onClick}
			className="bg-white border border-gray-100 rounded-lg text-center hover:shadow-lg align-center hover:cursor-pointer transition"
		>
			<div>
